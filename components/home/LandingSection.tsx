...
const Landing: FC = () => (
	<section className="flex flex-col w-full min-h-screen py-[4rem] md:py-[10rem] lg:py-[12rem] px-4 sm:px-6 md:px-8 items-center bg-white">
		<div className="flex flex-col w-full max-w-4xl mx-auto items-center gap-20">
			...
			<div className="flex flex-col w-full items-center max-w-2xl animate__animated animate__fadeInUp">
